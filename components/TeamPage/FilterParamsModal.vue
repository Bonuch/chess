<template>
    <div class='modal-body__wrapper'>
        ...
        <div class='content-wrapper'>
            <h2 class='text'>{{ $t('teamPage.pickParams') }}</h2>
            <div class='input-group mb-24'>
                <p class='input-label'>{{ $t("teamPage.gender") }}</p>
                <div class='input-switcher'>
                    <a @click.prevent='gender = 1' class='switcher' :class='{"active": gender === 1}'>{{ $t('teamPage.male') }}</a>
                    <a @click.prevent='gender = 2' class='switcher'
                       :class='{"active": gender === 2}'>{{ $t('teamPage.female') }}</a>
                </div>
            </div>
            ...
            <div class='flex second-block mb-24'>
                ...
                <div class='input-group second-block flex flex-column'>
                    <p class='input-label'>{{ $t("teamPage.trainerDegree") }}</p>
            ...
            <div class='input-group mb-24'>
                <p class='input-label'>{{ $t("teamPage.lessonLang") }}</p>
                <div class='lang-radios'>
                    <BaseRadio class='radio-item' v-model='pickedLanguage' name='lang' val='1' :label='$t("teamPage.Русский")'
                               id='russian'></BaseRadio>
                    <BaseRadio class='radio-item' v-model='pickedLanguage' name='lang' val='2' :label='$t("teamPage.Английский")'
