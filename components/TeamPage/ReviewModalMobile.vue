    ...
    <div class='modal-body__wrapper'>
        <div class='content-wrapper'>
            <div class='rating-container'>
                <p class='mark-title'>{{ $t('teamPage.mark') }}</p>
                <ReviewRating :trainer-id='trainer.id' :star-size='32' @update-rating='handleRatingUpdate' />
                <small
