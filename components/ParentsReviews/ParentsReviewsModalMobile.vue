...
import RateButtonMobile from '@/components/TeamPage/RateButtonMobile';
import ReviewModalMobile from '@/components/TeamPage/ReviewModalMobile';
import ReviewBlockMobile from '@/components/TeamPage/ReviewBlockMobile';

export default {
    name: 'ParentsReviewsModalMobile',
